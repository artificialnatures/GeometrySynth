...
#define NODE_ADDRESS 9  // Change this unique address for each I2C slave node
...
{ 
  ...
  nodePayload[1] = analogRead(A2)/4; // Read A0 and fit into 1 byte. Replace this line with your sensor value
